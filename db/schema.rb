...
ActiveRecord::Schema[8.0].define(version: 6) do
  create_table "card_plays", force: :cascade do |t|
    ...
    t.index ["trick_id", "play_order"], name: "index_card_plays_on_trick_id_and_play_order", unique: true
  ...
  create_table "players", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["game_id", "seat"], name: "index_players_on_game_id_and_seat", unique: true, where: "seat IS NOT NULL"
    t.index ["game_id", "session_id"], name: "index_players_on_game_id_and_session_id", unique: true
  ...
  create_table "tricks", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["round_id", "number"], name: "index_tricks_on_round_id_and_number", unique: true
